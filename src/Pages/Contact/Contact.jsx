...
const Contact = () => {
  ...
  return (
    <div>
      <Helmet>
        <title>StudyCamp | Contact Us</title>
      </Helmet>
      <div className="hero min-h-[500px] bg-base-200 relative overflow-hidden">
        <div className="hero-content flex-col lg:flex-row-reverse">
          ...
          />
          <div>
            <h1 className="text-7xl font-bold mr-5">Contact Us</h1>
          </div>
        </div>
      </div>
      <div className="container my-24 mx-auto md:px-6">
        <section className="mb-32">
          ...
          <div className="container px-6 md:px-12">
            <div className="block rounded-lg bg-indigo-950 px-6 py-12 shadow-[0_2px_15px_-3px_rgba(0,0,0,0.07),0_10px_20px_-2px_rgba(0,0,0,0.04)] dark:bg-[hsla(0,0%,5%,0.7)] dark:shadow-black/20 md:py-16 md:px-12 -mt-[100px] backdrop-blur-[30px]">
              <div className="mb-12 grid gap-x-6 md:grid-cols-2 lg:grid-cols-4">
                ...
                <div className="mx-auto text-center">
                  ...
                  <h6 className="font-medium">nizamquan@gmail.com</h6>
                </div>
              </div>
